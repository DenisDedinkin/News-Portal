...
SECRET_KEY = 'django-insecure-9c3rj$bfgu#hrlu$(srnfshl%^c(a@)+5zk(d16)255w@+krmk'
...
INSTALLED_APPS = [
    ...
    'news_models.apps.NewsModelsConfig',
...
AUTHENTICATION_BACKENDS = [
    # Needed to login by username in Django admin, regar...dless of `allauth`
